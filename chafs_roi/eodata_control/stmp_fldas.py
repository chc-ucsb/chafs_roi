...
def ExtractAdmSTMP_fldas(year, fnid_dict):
    # Get filenames
    fn_data = '/home/chc-sandbox/people/donghoonlee/fldas/africa/SoilTemp00_10cm_tavg_{:04d}??.nc'
    ...
    filn_out_crop = '/home/donghoonlee/chafs/data/eodata/stmp_fldas/adm.stmp.fldas.crop.{:04d}.{:02d}.{:02d}.hdf'
    filn_out_all = '/home/donghoonlee/chafs/data/eodata/stmp_fldas/adm.stmp.fldas.all.{:04d}.{:02d}.{:02d}.hdf'
    ...
    fn_sample ='/home/chc-sandbox/people/donghoonlee/fldas/africa/SoilTemp00_10cm_tavg_198201.nc'
...
def stmp_fldas():
    ...
    fn_rdx_out = '/home/donghoonlee/chafs/data/eodata/rdx.adm.stmp.fldas.pickle'
    if False:
        fn_sample ='/home/chc-sandbox/people/donghoonlee/fldas/africa/SoilTemp00_10cm_tavg_198201.nc'
...
#     files_rm = sorted(glob.glob('/home/donghoonlee/chafs/data/eodata/stmp_fldas/adm.stmp.fldas.crop.????.??.??.hdf'))
#     if len(files_rm) > 0: 
