...
def ExtractAdmSMOS_fldas(year, fnid_dict):
    # Get filenames
    fn_data = '/home/chc-sandbox/people/dlee/fldas/africa/SoilMoi00_10cm_tavg_{:04d}??.nc'
    ...
    filn_out_crop = '/home/dlee/chafs/data/eodata/smos_fldas/adm.smos.fldas.crop.{:04d}.{:02d}.{:02d}.hdf'
    filn_out_all = '/home/dlee/chafs/data/eodata/smos_fldas/adm.smos.fldas.all.{:04d}.{:02d}.{:02d}.hdf'
    ...
    fn_sample ='/home/chc-sandbox/people/dlee/fldas/africa/SoilMoi00_10cm_tavg_198201.nc'
...
def smos_fldas():
    ...
    fn_rdx_out = '/home/dlee/chafs/data/eodata/rdx.adm.smos.fldas.pickle'
    if False:
        fn_sample ='/home/chc-sandbox/people/dlee/fldas/africa/SoilMoi00_10cm_tavg_198201.nc'
...
#     files_rm = sorted(glob.glob('/home/dlee/chafs/data/eodata/smos_fldas/adm.smos.fldas.crop.????.??.??.hdf'))
#     if len(files_rm) > 0: 
