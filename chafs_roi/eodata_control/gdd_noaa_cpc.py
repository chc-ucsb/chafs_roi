...
def ExtractAdmGDD_noaa(year, fnid_dict):
    ...
    filn_out_crop = '/home/donghoonlee/chafs/data/eodata/gdd_noaa-cpc/adm.gdd.noaa-cpc.crop.{:04d}.{:02d}.{:02d}.hdf'
    filn_out_all = '/home/donghoonlee/chafs/data/eodata/gdd_noaa-cpc/adm.gdd.noaa-cpc.all.{:04d}.{:02d}.{:02d}.hdf'
...
def gdd_noaa_cpc():
    ...
    files_rm = sorted(glob.glob('/home/donghoonlee/chafs/data/eodata/gdd_noaa-cpc/adm.gdd.noaa-cpc.crop.????.*.hdf'))[-45:]
    if len(files_rm) > 0: 
