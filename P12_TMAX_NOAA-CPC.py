...
def ExtractAdmTMAX_noaa(year, fnid_dict):
    ...
    filn_out_crop = '/home/dlee/chafs/data/eodata/tmax_noaa-cpc/adm.tmax.noaa-cpc.crop.{:04d}.{:02d}.{:02d}.hdf'
    filn_out_all = '/home/dlee/chafs/data/eodata/tmax_noaa-cpc/adm.tmax.noaa-cpc.all.{:04d}.{:02d}.{:02d}.hdf'
    ...
    with open('/home/dlee/chafs/data/eodata/rdx.adm.tmax.noaa-cpc.pickle', 'rb') as f:
...
if __name__ == '__main__':
    ...
    fn_rdx_out = '/home/dlee/chafs/data/eodata/rdx.adm.tmax.noaa-cpc.pickle'
    if False:
        fn_sample = '/home/chc-sandbox/people/dlee/temp_noaa-cpc/tmax.noaa-cpc.1979.01.01.nc'
    ...
    files_rm = sorted(glob.glob('/home/dlee/chafs/data/eodata/tmax_noaa-cpc/adm.tmax.noaa-cpc.crop.????.*.hdf'))[-45:]
    if len(files_rm) > 0: 
